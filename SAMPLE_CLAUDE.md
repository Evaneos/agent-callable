...
Supported commands: apt, awk, base64, basename, bat, cat, convert, cp, curl, cut, date, df, diff, dig, dirname, dmesg, docker, docker-compose, du, echo, env, envsubst, eslint, eza, file, find, flatpak, flux, free, gcloud, getconf, gh, git, gnome-extensions, gofmt, grep, groups, gsettings, gunzip, gzip, head, helm, hexdump, host, hostname, id, ip, journalctl, jq, krew, kubectl, kubectl-crossplane, kubectl-readonly, kubectx, kustomize, locale, ls, lsblk, lscpu, lsmem, lsmod, lspci, lsusb, md5sum, mkdir, npm, nslookup, od, paste, pgrep, ping, prettier, printenv, ps, pulumi, readlink, realpath, rg, ruff, sed, seq, sha256sum, sleep, sort, ss, stat, strings, systemctl, tail, tar, tee, timedatectl, tldr, touch, tr, traceroute, tree, tsc, ty, type, udevadm, uname, uniq, unzip, uptime, uv, wc, whereis, which, whoami, whois, xargs, xdg-mime, xxd, yamllint, yq.
